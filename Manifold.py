						...
						for n in range(-1,2):
							if v[i][j][k] != v[l][m][n]:
								if ((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.5 > 1:
									...
									if v[i][j][k].x< v[l][m][n].x:
										v[i][j][k].x -= (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
									else:
										v[i][j][k].x += (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
									if  v[i][j][k].y < v[l][m][n].y:
										v[i][j][k].y -= (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
									else:
										v[i][j][k].y += (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
									if v[i][j][k].z < v[l][m][n].z:
										v[i][j][k].z -= (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
									else:
										v[i][j][k].z += (1/((((v[i][j][k].x - v[l][m][n].x)**2 + (v[i][j][k].y - v[l][m][n].y)**2 + (v[i][j][k].z - v[l][m][n].z)**2)**0.25 +10)*0.5))**3
					x2 = v[i][j][k].position
